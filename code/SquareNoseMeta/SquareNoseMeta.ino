...
// draw a blinking square on the "O" in "NOSE"
      arduboy.fillRect(46, 20, 16, 16, BLACK);
      if (arduboy.everyXFrames(2)) {
        arduboy.fillRect(46, 20, 16, 16, WHITE);
      }
...
// bug moves (sometimes it accelerates randomly)
...
// go to True Pasta screen (level intro screen)
      if (arduboy.justReleased(A_BUTTON)) {
        resetValues();
// you return to the title screen if you finish the game (third level)
        if (level == 3) {
          gameState = 0;
        } else {
